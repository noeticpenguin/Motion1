class AppDelegate
  ...
  def buildMenu
    ...
    addMenu('File') do
      addItemWithTitle('New Production Org Window', action: 'newProductionConnection:', keyEquivalent: 'n')
      addItemWithTitle('New Sandbox Org Window', action: 'newSandboxConnection:', keyEquivalent: 'S')
      addItemWithTitle('New Pre-Release Org Window', action: 'newPreReleaseConnection:', keyEquivalent: 'P')
      addItem(NSMenuItem.separatorItem)
